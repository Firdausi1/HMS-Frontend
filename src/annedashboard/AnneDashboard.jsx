  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        setPatientsCount(Array.isArray(patientsResp.data) ? patientsResp.data : []);
        ...
        <section className="grid grid-cols-4 gap-6 mb-8">
          <div className="relative bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div className="absolute top-3 left-3">
              <h3 className="text-xl font-bold text-black shadow-md">Patients</h3>
              <span className="text-4xl font-bold text-purple-500 shadow-md">{patientsCount?.length}</span>
            </div>
          </div>
          ...
          <div className="relative bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div className="absolute top-3 right-3">
              ...
              <span className="text-4xl font-bold text-purple-500 shadow-md ml-6">{queueCount?.length}</span>
            </div>
          </div>
          ...
          <div className="relative bg-white shadow-md rounded-lg overflow-hidden">
            ...
            />
            <div className="absolute top-3 left-3">
              <h3 className="text-xl font-bold text-white shadow-md">Appointments</h3>
              <span className="text-4xl font-bold text-purple-500 shadow-md">4</span>
            </div>
          </div>
        </section>
