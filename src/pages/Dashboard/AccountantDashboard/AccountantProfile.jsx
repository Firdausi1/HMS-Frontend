  ...
  const handleSubmitProfile = async (e) => {
    ...
    if (isEditable) {
      try {
        ...
        alert("Doctor Profile Updated!"); // Show success alert
      } catch (error) {
        console.error("Error Updating Doctor's Data:", error);
      }
    }
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-blue-50 flex items-center justify-center">
        <p className="text-lg text-gray-700">Loading Accountant's data...</p>
      </div>
    );
  }
